...
public final class MediaStorageImpl implements MediaStorage {
    ...
    private static final MediaStorage INSTANCE = new MediaStorageImpl();
    ...
    public String toString() {
        return "MediaStorageImpl [books=" + books + ", discs=" + discs + "]";
    }
    ...
    public boolean equals(Object obj) {
        ...
        MediaStorageImpl other = (MediaStorageImpl) obj;
